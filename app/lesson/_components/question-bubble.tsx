...
export const QuestionBubble = ({ question }: QuestionBubbleProps) => {
  return (
    <div className="flex items-center gap-x-4 mb-6">
      <Image src="/mascot.svg" width={60} height={60} alt="Mascot" className="hidden lg:block" />
      <Image src="/mascot.svg" width={40} height={40} alt="Mascot" className="block lg:hidden" />
